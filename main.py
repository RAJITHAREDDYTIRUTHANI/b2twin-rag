...
def create_comprehensive_analysis():
    """Create comprehensive analysis of all sensor data"""
    ...
    # Save structured data as JSON for web interface
    with open("results/sensor_data.json", "w", encoding="utf-8") as f:
        json.dump(all_data, f, indent=2, default=str)
    
    print("[SUCCESS] Comprehensive analysis saved to results/comprehensive_context.txt")
    print("[SUCCESS] Structured data saved to results/sensor_data.json")
    
    return all_data, context_summary
...
if __name__ == "__main__":
    ...
    all_data, context_summary = create_comprehensive_analysis()
    
    print("\n[SUCCESS] All sensor data analyzed and context created!")
    print("Files generated:")
    print("- results/comprehensive_context.txt (human-readable summary)")
    print("- results/sensor_data.json (structured data for web interface)")
